...
import (
	"errors"
	"os"
	router "repo.abs.com/hiring/allocate/src/apis/rest"
	...
	"repo.abs.com/hiring/allocate/src/utils"
	"strings"
)
...
func Initialise() (err error) {
	...
	// Initializes ORM (aerospike)
	err = aeroORM.Initialize()
	if err != nil {
		return errors.New("aeroORM error ->" + err.Error())
	}
